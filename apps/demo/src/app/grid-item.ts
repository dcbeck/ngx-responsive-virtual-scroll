...
@Component({
  ...
  standalone: true,
  imports: [RandomPhotoComponent, StarIconComponent, NgClass],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    <div
      class="bg-white rounded-lg max-w-full max-h-full h-full flex flex-col shadow-md overflow-hidden transform transition hover:scale-105 min-w-8 group"
      [ngClass]="{
        'ring-4  ring-blue-500 !bg-blue-50': this.isSelected()
      }"
    >
      <demo-random-photo
      ...
      <div class="p-4 flex flex-col flex-1 w-full">
        ...
        <p class="text-gray-600 mb-4 flex-1 line-clamp-2 truncate min-w-0 text-sm">
